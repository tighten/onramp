<template>
    ...
    >
        <template slot-scope="{ toggle, isCompleted }">
            <button
                class="flex items-center justify-center w-full px-5 py-2 mt-8 font-semibold leading-none text-white transition-colors duration-150 ease-in-out border-2 border-white rounded-md hover:bg-white hover:text-teal focus:outline-none md:max-w-xs md:py-3 lg:mt-0"
