<template>
    <p class="mb-8">
        <button
            @click="showAll()"
            class="mr-2 font-semibold text-gray-600 cursor-pointer duration-150 transition ease-in-out hover:text-gray-700 lg:mr-4"
        ...
        <span v-if="language !== 'English'">
            <button
                ...
                class="font-semibold text-gray-600 cursor-pointer duration-150 transition ease-in-out hover:text-gray-700"
