export default {
    'cs.auth': {
        ...
        throttle:
            'P\u0159\u00edli\u0161 mnoho pokus\u016f o p\u0159ihl\u00e1\u0161en\u00ed. Zkuste znovu za :seconds sekund.',
    },
    'cs.pagination': { previous: '&laquo; P\u0159edchoz\u00ed', next: 'Dal\u0161\u00ed &raquo;' },
    'cs.passwords': {
        password:
            'Hesla mus\u00ed obsahovat minim\u00e1ln\u011b 8 znak\u016f a mus\u00ed se shodovat s ov\u011b\u0159en\u00edm.',
        reset: 'Va\u0161e heslo bylo obnoveno!',
        sent: 'E-mail s instrukcemi k obnoven\u00ed hesla byl odesl\u00e1n!',
        token: 'Kl\u00ed\u010d pro nastaven\u00ed nov\u00e9ho hesla je nespr\u00e1vn\u00fd.',
    ...
    'cs.validation': {
        ...
        ends_with:
            ':attribute mus\u00ed kon\u010dit jednou z n\u00e1sleduj\u00edc\u00edch hodnot: :values',
        ...
        required_with:
            ':attribute mus\u00ed b\u00fdt vypln\u011bno pokud :values je vypln\u011bno.',
        required_with_all: ':attribute mus\u00ed b\u00fdt vypln\u011bno pokud :values je zvoleno.',
        required_without:
            ':attribute mus\u00ed b\u00fdt vypln\u011bno pokud :values nen\u00ed vypln\u011bno.',
        required_without_all:
            ':attribute mus\u00ed b\u00fdt vypln\u011bno pokud nen\u00ed \u017e\u00e1dn\u00e9 z :values zvoleno.',
        ...
        starts_with:
            ':attribute mus\u00ed za\u010d\u00ednat jednou z n\u00e1sleduj\u00edc\u00edch hodnot: :values',
    ...
    'da.pagination': { previous: '&laquo; Forrige', next: 'N\u00e6ste &raquo;' },
    'da.passwords': {
        password:
            'Adgangskoden skal v\u00e6re mindst otte tegn og svare til feltet bekr\u00e6ft adgangskode.',
    ...
    'da.validation': {
        ...
        alpha_dash:
            ':attribute m\u00e5 kun indeholde bogstaver, tal, bindestreg eller underscores.',
        ...
        required_without_all:
            'Feltet :attribute er kr\u00e6vet n\u00e5r ingen af :values er udfyldte.',
    ...
    'de.pagination': { previous: '&laquo; Vorherige', next: 'N\u00e4chste &raquo;' },
    'de.passwords': {
        password:
            'Passw\u00f6rter m\u00fcssen aus mindestens acht Zeichen bestehen und mit der Best\u00e4tigung \u00fcbereinstimmen.',
    ...
    'en.operatingsystems': { any: 'Any', macos: 'macOS', windows: 'Windows', linux: 'Linux' },
    'en.pagination': { previous: '&laquo; Previous', next: 'Next &raquo;' },
    'en.passwords': {
    ...
    'es.auth': {
        ...
        throttle:
            'Demasiados intentos fallidos en muy poco tiempo. Por favor intente de nuevo en :seconds segundos.',
    },
    'es.pagination': { previous: '&laquo; Anterior', next: 'Siguiente &raquo;' },
    'es.passwords': {
        password:
            'La contrase\u00f1a debe tener al menos ocho caracteres y coincidir con la confirmaci\u00f3n.',
    ...
    'fr.auth': {
        ...
        throttle:
            'Trop de tentatives de connexion. Veuillez r\u00e9essayer dans: secondes secondes.',
    },
    'fr.pagination': { previous: '&laquo; Pr\u00e9c\u00e9dent', next: 'Suivant &raquo;' },
    'fr.passwords': {
        password:
            'Votre most de passe doit \u00eatre au moins huit charact\u00e8res et correspondre \u00e0 la confirmation.',
        reset: 'Votre mot de passe \u00e0 \u00e9t\u00e9 reinitialis\u00e9!',
        sent: 'Nous vous avons envoy\u00e9 un courrier \u00e9lectronique avec le lien pour r\u00e9initialiser votre mot de passe!',
        token: 'Ce jeton de r\u00e9initialisation de mot de passe est invalide.',
        user: "Nous n'avons pas trouv\u00e9 d'utilisateur avec cette addresse \u00e9lectronique.",
    },
    'fr.validation': {
        ...
        after_or_equal:
            'Le champ :attribute doit \u00eatre une date apr\u00e8s ou \u00e9gale \u00e0 :date.',
        alpha: 'Le champ :attribute doit seulement contenir des lettres.',
        alpha_dash:
            'Le champ :attribute peut seulement contenir des lettres, chiffres, tirets et tirets-bas.',
        ...
        before_or_equal:
            'Le champ :attribute doit \u00eatre une date avant ou \u00e9gale \u00e0 :date.',
        between: {
        ...
        lte: {
            numeric:
                'Le champ :attribute doit \u00eatre inf\u00e9rieur ou \u00e9gal \u00e0 :value.',
        ...
        required_unless:
            'Le champ :attribute est requis \u00e0 moins que :other soit pr\u00e9sent dans les valeurs :values.',
        required_with: 'Le champ :attribute est requis quand :values est pr\u00e9sent.',
        required_with_all:
            'Le champ :attribute est requis quand les valeurs :values sont pr\u00e9sentes.',
        required_without:
            'Le champ :attribute est requis quand les valeurs :values ne sont pas pr\u00e9sentes.',
        required_without_all:
            'Le champ :attribute est requis quand aucunes des valeurs :values sont pr\u00e9sentes.',
    ...
    'id.auth': {
        failed: 'Kami tidak menemukan akun anda.',
        throttle: 'Terlalu banyak percobaan masuk. Silahkan coba kembali dalam :seconds detik.',
    },
    'id.operatingsystems': { any: 'Lainnya', macos: 'macOS', windows: 'Windows', linux: 'Linux' },
    'id.pagination': { previous: '&laquo; Sebelumnya', next: 'Selanjutnya &raquo;' },
    'id.passwords': {
    ...
    'id.validation': {
        ...
        alpha_dash:
            ':attribute cuma boleh mengandung huruf, angka, tanda penghubung, dan garis bawah.',
    ...
    'pt_pt.auth': {
        ...
        throttle:
            'O n\u00famero limite de tentativas de login foi atingido. Por favor tente novamente dentro de :seconds segundos.',
    },
    'pt_pt.pagination': { previous: '&laquo; Anterior', next: 'Seguinte &raquo;' },
    'pt_pt.passwords': {
        password:
            'A palavra-passe dever\u00e1 conter pelo menos seis carateres e ser igual \u00e0 confirma\u00e7\u00e3o.',
    ...
    'sv.pagination': { previous: '&laquo; F\u00f6reg\u00e5ende', next: 'N\u00e4sta &raquo;' },
    'sv.passwords': {
        password:
            'L\u00f6senord m\u00e5ste vara minst 8 tecken och m\u00e5ste matcha bekr\u00e4ftelse-f\u00e4ltet',
    ...
    'sv.validation': {
        ...
        after_or_equal:
            'Attributet :attribute m\u00e5ste vara ett datum efter eller samma som :date.',
        alpha: 'Attributet :attribute f\u00e5r bara inneh\u00e5lla bokst\u00e4ver.',
        alpha_dash:
            'Attributet :attribute f\u00e5r bara inneh\u00e5lla bokst\u00e4ver, siffror, - eller _.',
        ...
        before_or_equal:
            'Attributet :attribute m\u00e5ste vara ett datum f\u00f6re eller samma som :date.',
        between: {
            numeric:
                'Attributet :attribute m\u00e5ste vara st\u00f6rre \u00e4n :min och mindre \u00e4n :max.',
        ...
        digits_between:
            'Attributet :attribute m\u00e5ste vara fler \u00e4n :min och mindre \u00e4n :max siffror.',
        ...
        ends_with:
            'Attributet :attribute m\u00e5ste sluta med n\u00e5got av f\u00f6ljande: :values',
    ...
    'cs.__JSON__': {
        'Onramp to Laravel': 'Onramp k Laravelu',
        'Providing an easy entrance to Laravel for new developers':
            'Poskytov\u00e1n\u00ed snadn\u00e9ho vstupu do Laravelu pro nov\u00e9 v\u00fdvoj\u00e1\u0159e',
        Home: 'Dom\u016f',
        Learn: 'Lekce',
        Glossary: 'Glos\u00e1\u0159',
        'Learn Laravel': 'Nau\u010dte se Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'Technick\u00e9 koncepty, kter\u00e9 byste m\u011bli zn\u00e1t, abyste z\u00edskali pr\u00e1ci v\u00fdvoj\u00e1\u0159e v Laravelu.',
        "That's all, for now.": 'To je prozat\u00edm v\u0161e.',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Ji\u017e brzy: v\u00edce a l\u00e9pe organizovan\u00e9 odkazy na m\u00edsta, kde se lze nau\u010dit ka\u017edou z t\u011bchto technologi\u00ed \/ n\u00e1stroj\u016f, podrobn\u011bj\u0161\u00ed seznam technologi\u00ed, atd. A pozd\u011bji mo\u017en\u00e1 cvi\u010den\u00ed, kter\u00e1 Va\u0161e znalosti vyzkou\u0161\u00ed a prok\u00e1\u017eou, kolik jste se toho ji\u017e nau\u010dili.',
        'Log in': 'P\u0159ihl\u00e1sit se',
        ...
        'Reset Password Notification': 'Ozn\u00e1men\u00ed o obnoven\u00ed hesla',
        'You are receiving this email because we received a password reset request for your account.':
            'Tento e-mail jste obdr\u017eeli, proto\u017ee jsme obdr\u017eeli \u017e\u00e1dost o obnoven\u00ed hesla pro V\u00e1\u0161 \u00fa\u010det',
        'This password reset link will expire in :count minutes.':
            'Tento odkaz na obnoven\u00ed hesla vypr\u0161\u00ed b\u011bhem :count minut.',
        'If you did not request a password reset, no further action is required.':
            'Pokud jste nepo\u017e\u00e1dali o obnoven\u00ed hesla, nen\u00ed nutn\u00e1 \u017e\u00e1dn\u00e1 dal\u0161\u00ed akce.',
        Regards: 'S pozdravem',
        'Whoops!': 'Jejda!',
        'Hello!': 'Ahoj!',
        'If you\u2019re having trouble clicking the ":actionText" button, copy and paste the URL below\ninto your web browser: [:actionURL](:actionURL)':
            'Pokud m\u00e1te pot\u00ed\u017ee s kliknut\u00edm na ":actionText" tla\u010d\u00edtko, zkop\u00edrujte a vlo\u017ete n\u00ed\u017ee uvedenou adresu URL\n do Va\u0161eho webov\u00e9ho prohl\u00ed\u017ee\u010de: [:actionURL](:actionURL)',
        'Send Password Reset Link': 'Odeslat odkaz na obnoven\u00ed hesla',
        Logout: 'Odhl\u00e1sit se',
        'Verify Email Address': 'Ov\u011b\u0159te emailovou adresu',
        'Please click the button below to verify your email address.':
            'Pro ov\u011b\u0159en\u00ed Va\u0161\u00ed emailov\u00e9 adresy pros\u00edm klikn\u011bte na tla\u010d\u00edtko n\u00ed\u017ee.',
        'If you did not create an account, no further action is required.':
            'Pokud jste si nevytvo\u0159ili \u00fa\u010det, nen\u00ed nutn\u00e1 \u017e\u00e1dn\u00e1 dal\u0161\u00ed akce.',
        'Verify Your Email Address': 'Ov\u011b\u0159te Va\u0161i emailovou adresu',
        'A fresh verification link has been sent to your email address.':
            'Na Va\u0161i e-mailovou adresu byl odesl\u00e1n nov\u00fd ov\u011b\u0159ovac\u00ed odkaz.',
        'Before proceeding, please check your email for a verification link.':
            'Ne\u017e budete pokra\u010dovat, zkontrolujte pros\u00edm v e-mailu ov\u011b\u0159ovac\u00ed odkaz.',
        'If you did not receive the email': 'Pokud jste e-mail neobdr\u017eeli',
        'click here to request another':
            'klikn\u011bte sem a vy\u017e\u00e1dejte si dal\u0161\u00ed',
    ...
    'da.__JSON__': {
        'Onramp to Laravel': 'Tilk\u00f8rsel til Laravel',
        'Providing an easy entrance to Laravel for new developers':
            'Giver en nem entr\u00e9 til Laravel for nye udviklere',
        Home: 'Hjem',
        Learn: 'L\u00e6r',
        Glossary: 'Ordliste',
        'Learn Laravel': 'L\u00e6r Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'De tekniske koncepter du burde kende for at f\u00e5 et job som Laravel udvikler',
        "That's all, for now.": 'Det var alt, indtil videre',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Snart: flere og bedre organiserede links til steder for at l\u00e6re hver af disse teknologier \/ v\u00e6rkt\u00f8jer, en mere robust liste over teknologier osv., Og derefter senere m\u00e5ske \u00f8velser for at teste dem og bevise din l\u00e6ring.',
        'Log in': 'Log p\u00e5',
        ...
        'You are receiving this email because we received a password reset request for your account.':
            'Du modtager denne e-mail fordi vi har modtaget en foresp\u00f8rgelse om nulstilling af adgangskode til din konto',
        'This password reset link will expire in :count minutes.':
            'Denne nulstil adgangskode link vil udl\u00f8be om :count minutter.',
        'If you did not request a password reset, no further action is required.':
            'Hvis du ikke bad om at f\u00e5 nulstillet din adgangskode, skal du ikke foretage dig yderligerer.',
        Regards: 'Hilsen',
        'Whoops!': 'Hooovsa!',
        'Hello!': 'Hej!',
        'If you\u2019re having trouble clicking the ":actionText" button, copy and paste the URL below\ninto your web browser: [:actionURL](:actionURL)':
            'Hvis du har problemer med at trykke p\u00e5 ":actionText"-knappen, kopier dette link\nind i din browser: [:actionURL] (:actionURL)',
        'Send Password Reset Link': 'Send link til nulstilling af adgangskode',
        Logout: 'log ud',
        'Verify Email Address': 'Verificer din e-mail adresse',
        'Please click the button below to verify your email address.':
            'Venligst klik p\u00e5 knappen under for at verficer din e-mail adresse.',
        'If you did not create an account, no further action is required.':
            'Hvis du ikke har lavet en bruger, beh\u00f8ver du ikke at foretage dig yderligerer.',
        'Verify Your Email Address': 'Verificer din e-mail adresse',
        'A fresh verification link has been sent to your email address.':
            'Et nyt verificerings-link er blevet sendt til din e-mail adresse.',
        'Before proceeding, please check your email for a verification link.':
            'F\u00f8r du forts\u00e6tter, venligst tjek din e-mail for et verificerings link.',
        'If you did not receive the email': 'hvis du ikke modtog e-mailen',
        'click here to request another': 'klik her for at f\u00e5 en ny',
        ...
        'From the lovely folks at': 'Fra de herlige folk hos',
        'Source & Roadmap': 'Kildekode & roadmap',
        'Table of contents': 'Indholdsfortegnelse',
        'All resources': 'Alle ressourcer',
        ':locale resources': ':locale ressourcer',
        'English and :locale resources': 'Engelsk og :locale ressourcer',
        Preferences: 'Indstillinger',
        'My preferences': 'Mine indstillinger',
        'Account Preferences': 'Konto indstillinger',
        'Which resources should we show for you?': 'Hvilke ressourcer skal vi vise dig?',
        'Only resources for my language': 'Kun ressourcer for mit sprog',
        'Only resources for my language and English': 'Kun ressourcer for mit sprog og engelsk',
        'Preferred Language': 'Foretrukne sprog',
        'Preferred Operating System': 'Foretrukket operativsystem',
    },
    'de.__JSON__': {
        'Onramp to Laravel': 'Auffahrt zu Laravel',
        'Providing an easy entrance to Laravel for new developers':
            'Erleichtert den Zugang zu Laravel f\u00fcr neue Entwickler',
        Home: 'Home',
        Learn: 'Lernen',
        Glossary: 'Glossar',
        'Learn Laravel': 'Lerne Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'Die technischen Konzepte, die du kennen solltest, um eine Stelle als Laravel-Entwickler zu erhalten.',
        "That's all, for now.": 'Das ist alles, f\u00fcr den Moment.',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Bald: mehr und besser organisierte Links zu Orten, an denen man jede dieser Technologien\/Tools lernen kann, eine robustere Liste von Technologien usw., und dann sp\u00e4ter vielleicht \u00dcbungen, um sie zu testen und das Gelernte zu \u00fcberpr\u00fcfen.',
        'Log in': 'Login',
        'E-Mail Address': 'E-Mail-Adresse',
        Password: 'Passwort',
        ...
        'Reset Password Notification': 'Benachrichtigung um das Passwort zur\u00fcck zu setzen',
        'You are receiving this email because we received a password reset request for your account.':
            'Du erh\u00e4ltst diese E-Mail weil wir eine Anfrage zum Zur\u00fccksetzen des Passwortes f\u00fcr deinen Account erhalten haben.',
        'This password reset link will expire in :count minutes.':
            'Dieser Link wird in :count Minute verfallen.',
        'If you did not request a password reset, no further action is required.':
            'Wenn du keine Anfrage zum Zur\u00fccksetzen des Passworts angefragt hast, musst du nichts weiter tun.',
        Regards: 'Mit freundlichen Gr\u00fc\u00dfen',
        'Whoops!': 'Hoppla!',
        'Hello!': 'Hallo!',
        'If you\u2019re having trouble clicking the ":actionText" button, copy and paste the URL below\ninto your web browser: [:actionURL](:actionURL)':
            'Wenn du Probleme hast, den ":actionText" Button anzuklicken, kopiere die unten angegebene URL\nund f\u00fcge sie in deinen Webbrowser ein: [:actionURL](:actionURL)',
        'Send Password Reset Link': 'Link zum Passwort-Zur\u00fccksetzen versenden',
        Logout: 'Logout',
        'Verify Email Address': 'Best\u00e4tige deine E-Mail-Adresse',
        'Please click the button below to verify your email address.':
            'Bitte klicke unten auf den Button, um eine E-Mail-Adresse zu best\u00e4tigen.',
        'If you did not create an account, no further action is required.':
            'Wenn du keinen Account angelegt hast, ist deinerseits kein weiteres Handeln n\u00f6tig.',
        'Verify Your Email Address': 'Best\u00e4tige deine E-Mail-Adresse',
        'A fresh verification link has been sent to your email address.':
            'Ein neuer Best\u00e4tigungslink wurde an deine E-Mail-Adresse versendet.',
        'Before proceeding, please check your email for a verification link.':
            'Bitte \u00fcberpr\u00fcfe deine E-Mail-Adresse auf einen Best\u00e4tigungslink, bevor du fortsetzt.',
        'If you did not receive the email': 'Wenn du keine E-Mail erhalten hast',
        'click here to request another': 'klicke hier um eine Neue anzufragen',
        'Back to login': 'Zur\u00fcck zum Login',
        "Don't have an account?": 'Hast du keinen Account?',
        'Already have an account?': 'Hast du bereits einen Account?',
        'From the lovely folks at': 'Von den netten Leuten bei',
        'Source & Roadmap': 'Quelle & Roadmap',
        'Table of contents': 'Inhaltsverzeichnis',
        'All resources': 'Alle Ressourcen',
        ':locale resources': 'Ressourcen in :locale',
        'English and :locale resources': 'Ressourcen in :locale und Englisch',
        Preferences: 'Einstellungen',
        'My preferences': 'Meine Einstellungen',
        'Account Preferences': 'Account-Einstellungen',
        'Which resources should we show for you?': 'Welche Ressourcen sollen wir dir zeigen?',
        'Only resources for my language': 'Nur Ressourcen f\u00fcr meine Sprache',
        'Only resources for my language and English':
            'Nur Ressourcen f\u00fcr meine Sprache und Englisch',
        'Preferred Language': 'Bevorzugte Sprache',
        'Preferred Operating System': 'Bevorzugtes Betriebssystem',
    },
    'en.__JSON__': {
        'All resources': 'All resources',
        ':locale resources': ':locale resources',
        'English and :locale resources': 'English and :locale resources',
        Actions: 'Actions',
        Details: 'Details',
        'If you did not request a password reset, no further action is required.':
            'If you did not request a password reset, no further action is required.',
    ...
    'es.__JSON__': {
        ...
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'Los conceptos t\u00e9cnicos que deberias aprender para obtener un trabajo como un desarrollador de Laravel.',
        "That's all, for now.": 'Eso es todo por ahora.',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Pronto: mejores enlaces con mayor organizaci\u00f3n a lugares donde se podr\u00e1n aprender cada una de estas tecnolog\u00edas\/herramientas, una lista m\u00e1s robusta de tecnolog\u00edas, etc. Y, tal vez, m\u00e1s adelante algunos ejercicios o pruebas para probar lo que hayas aprendido.',
        Glossary: 'Glosario',
        ...
        'This password reset link will expire in :count minutes.':
            'Este enlace para restablecer la contrase\u00f1a caduca en :count minutos.',
        'If you did not request a password reset, no further action is required.':
        ...
        'Please click the button below to verify your email address.':
            'Por favor pulsa el siguiente bot\u00f3n para verificar tu correo electr\u00f3nico.',
        'If you did not create an account, no further action is required.':
            'Si no has creado una cuenta, puedes ignorar o eliminar este email.',
        'Verify Your Email Address': 'Verifica tu correo electr\u00f3nico',
        'A fresh verification link has been sent to your email address.':
            'Se ha enviado un nuevo enlace de verificaci\u00f3n a tu correo electr\u00f3nico.',
        'Before proceeding, please check your email for a verification link.':
            'Antes de continuar, por favor, verifica tu correo electr\u00f3nico con el enlace que te hemos enviado.',
        ...
        'From the lovely folks at': 'De la gente encantadora en',
        'Source & Roadmap': 'Fuente & Hoja de ruta',
        'All resources': 'Todo los recursos',
        ':locale resources': 'Recursos en :locale',
        'English and :locale resources': 'Recursos en ingles y :locale',
    },
    'fr.__JSON__': {
        Home: 'Accueil',
        Learn: 'Apprendre',
        'Learn Laravel': 'Apprendre Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'Les concepts techniques que vous devez conna\u00eetre afin de trouver un job en tant que d\u00e9velopeur Laravel.',
        "That's all, for now.": "C'est tout pour le moment.",
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Bient\u00f4t: plus de liens de qualit\u00e9 et organis\u00e9s vers des resources pour apprendre chacunes de ces technologies\/outils, une liste plus robuste de technologies, etc., et plus tard peut \u00eatre des exercices pour les tester et approuver votre apprentissage.',
        Glossary: 'Glossaire',
        'Table of contents': 'Table des mati\u00e8res',
        'No terms': 'Aucun engagement',
        ...
        'Reset Password Notification': 'Avis de r\u00e9initialisation de mot de passe',
        'You are receiving this email because we received a password reset request for your account.':
            'Vous recevez cet email car nous avons re\u00e7u une requ\u00eatre de r\u00e9initialisation de mot de passe pour votre compte.',
        'This password reset link will expire in :count minutes.':
            'Ce lien pour r\u00e9initialiser votre mot de passe expirera dans :count minutes.',
        'If you did not request a password reset, no further action is required.':
            "Si vous n'avez pas demand\u00e9 \u00e0 r\u00e9initialiser votre mot de passe, aucune action de votre part est n\u00e9cessaire.",
        Regards: 'Cordialement',
        'Whoops!': 'Oups!',
        'Hello!': 'Bonjour',
        'If you\u2019re having trouble clicking the ":actionText" button, copy and paste the URL below\ninto your web browser: [:actionURL](:actionURL)':
            'Si vous avez des difficult\u00e9s \u00e0 cliquer sur le bouton ":actionText", copiez et collez l\'adresse suivante\ndans votre navigateur: [:actionURL](:actionURL)',
        'Send Password Reset Link': 'Envoyer un lien pour re\u00e9initialiser le mot de passe',
        Logout: 'Quitter',
        'Verify Email Address': "Verifier l'adresse \u00e9lectronique",
        'Please click the button below to verify your email address.':
            'Cliquez sur le bouton ci-dessous pour v\u00e9rifier votre adresse \u00e9lectronique.',
        'If you did not create an account, no further action is required.':
            "Si vous n'avez pas cr\u00e9\u00e9 de compte, aucune action de votre part est n\u00e9cessaire.",
        'Verify Your Email Address': 'Verifier votre adresse \u00e9lectronique',
        'A fresh verification link has been sent to your email address.':
            'Un lien de v\u00e9rification vous \u00e0 \u00e9t\u00e9 envoy\u00e9 \u00e0 votre adresse \u00e9lectronique.',
        'Before proceeding, please check your email for a verification link.':
            'Avant de continuer, v\u00e9rifiez vos messages pour un lien de v\u00e9rification.',
        'If you did not receive the email': "Si vous n'avez pas re\u00e7u de message",
        'click here to request another': 'cliquez ici pour en demander un autre',
        'Back to login': "Retour \u00e0 l'\u00e9cran de connexion",
        "Don't have an account?": "Vous n'avez pas de compte?",
        'Already have an account?': 'Vous avez d\u00e9j\u00e0 un compte?',
        'From the lovely folks at': 'Par les incroyables gens de',
        'Source & Roadmap': 'Code source & projets',
        'All resources': 'Toutes les resources',
        ':locale resources': 'Resources en :locale',
        'English and :locale resources': 'Resources en anglais et :locale',
    },
    'id.__JSON__': {
        'Onramp to Laravel': 'Onramp ke Laravel',
        'Providing an easy entrance to Laravel for new developers':
            'Memudahkan developer baru untuk menguasai Laravel',
        Home: 'Beranda',
        Learn: 'Belajar',
        Glossary: 'Glosarium',
        'Learn Laravel': 'Belajar Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'Konsep-konsep teknologi yang wajib kamu kuasai untuk mendapatkan pekerjaan sebagai Laravel Developer',
        "That's all, for now.": 'Cukup sekian.',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Soon: Link yang update ke tempat belajar mengenai teknologi-teknologi ini, daftar teknologi yang lebih handal, dst., dan kedepannya latihan-latihan untuk mencoba teknologi-teknologi ini dan mengevaluasi apa yang telah kamu pelajari.',
        'Log in': 'Masuk',
        ...
        'Reset Password Notification': 'Notifikasi Reset Kata Sandi',
        'You are receiving this email because we received a password reset request for your account.':
            'Kamu menerima email ini karena kami telah menerima permohonan reset kata sandi dari akun kamu',
        'This password reset link will expire in :count minutes.':
            'Link reset kata sandi ini akan expire dalam :count menit.',
        'If you did not request a password reset, no further action is required.':
            'Jika kamu merasa tidak melakukan permohonan reset kata sandi, abaikan email ini.',
        Regards: 'Salam',
        'Whoops!': 'Aduh!',
        'Hello!': 'Halo!',
        'If you\u2019re having trouble clicking the ":actionText" button, copy and paste the URL below\ninto your web browser: [:actionURL](:actionURL)':
            'Jika kamu mengalami kesulitan untuk mengklik tombol ":actionText", copy dan paste URL di bawah ini \nke browser kamu: [:actionURL](:actionURL)',
        'Send Password Reset Link': 'Kirim Link Reset Kata Sandi',
        Logout: 'Keluar',
        'Verify Email Address': 'Verifikasi Alamat Email',
        'Please click the button below to verify your email address.':
            'Silahkan klik tombol di bawah ini untuk memverikasi emailmu.',
        'If you did not create an account, no further action is required.':
            'Jika kamu merasa tidak membuat akun di onramp.dev, abaikan email ini.',
        'Verify Your Email Address': 'Verifikasi Alamat Email',
        'A fresh verification link has been sent to your email address.':
            'Link terbaru verifikasi email telah dikirim ke alamat email kamu.',
        'Before proceeding, please check your email for a verification link.':
            'Sebelum melanjutkan, tolong cek email kamu untuk melakukan verifikasi email.',
        'If you did not receive the email': 'Jika kamu tidak menerima email yang dimaksud',
        'click here to request another': 'klik di sini untuk pengiriman ulang',
        ...
        'From the lovely folks at': 'Dari orang-orang yang menyenangkan di',
        'Source & Roadmap': 'Sumber & Peta Jalan',
        'Table of contents': 'Daftar isi',
        'All resources': 'Semua Materi',
        ':locale resources': 'Materi dalam Bahasa Indonesia',
        'English and :locale resources': 'Materi dalam Bahasa Inggris & Bahasa Indonesia',
    },
    'pt_pt.__JSON__': {
        Home: 'In\u00edcio',
        Learn: 'Aprenda',
        'Learn Laravel': 'Aprenda Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'Os conceitos t\u00e9cnicos que deve saber para conseguir um emprego como programador Laravel.',
        "That's all, for now.": '\u00c9 tudo, por agora.',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Brevemente: uma melhor organiza\u00e7\u00e3o de links para aprender cada uma destas tecnologias\/ferramentas, uma lista mais robusta de tecnologias, etc., e mais tarde, talvez exerc\u00edcios para poder testar e comprovar a sua aprendizagem.',
        'Log in': 'Login',
        'E-Mail Address': 'Endere\u00e7o de correio eletr\u00f3nico',
        ...
        'Reset Password Notification': 'Redefinir notifica\u00e7\u00e3o de palavra-passe',
        'You are receiving this email because we received a password reset request for your account.':
            'Est\u00e1 a receber este email porque recebemos um pedido de redefini\u00e7\u00e3o de palavra-passe da sua conta.',
        'This password reset link will expire in :count minutes.':
            'Este link de redefini\u00e7\u00e3o de palavra-passe vai expirar em :count minutos.',
        'If you did not request a password reset, no further action is required.':
            'Se n\u00e3o solicitou uma redefini\u00e7\u00e3o de palavra-passe, n\u00e3o \u00e9 necess\u00e1ria qualquer a\u00e7\u00e3o adicional.',
        Regards: 'Cumprimentos',
        'Whoops!': 'Opa!',
        'Hello!': 'Ol\u00e1!',
        'If you\u2019re having trouble clicking the ":actionText" button, copy and paste the URL below\ninto your web browser: [:actionURL](:actionURL)':
            'Se estiver com problemas em clicar no bot\u00e3o ":actionText", copie e cole o link abaixo\nno seu navegador de internet: [:actionURL] (:actionURL)',
        'Send Password Reset Link': 'Enviar link de redefini\u00e7\u00e3o de palavra-passe',
        Logout: 'Sair',
        'Verify Email Address': 'Verificar endere\u00e7o de correio eletr\u00f3nico',
        'Please click the button below to verify your email address.':
            'Por favor, clique no bot\u00e3o abaixo para verificar o seu endere\u00e7o de correio eletr\u00f3nico.',
        'If you did not create an account, no further action is required.':
            'Se n\u00e3o criou uma conta, n\u00e3o \u00e9 necess\u00e1ria qualquer a\u00e7\u00e3o adicional.',
        'Verify Your Email Address': 'Verifique o seu endere\u00e7o de correio eletr\u00f3nico',
        'A fresh verification link has been sent to your email address.':
            'Um novo link de verifica\u00e7\u00e3o foi enviado para o seu endere\u00e7o de correio eletr\u00f3nico.',
        'Before proceeding, please check your email for a verification link.':
            'Antes de prosseguir, verifique no seu correio eletr\u00f3nico por um link de verifica\u00e7\u00e3o.',
        'If you did not receive the email': 'Se n\u00e3o recebeu o correio eletr\u00f3nico',
        'click here to request another': 'clique aqui para solicitar outro',
        'Back to login': 'Voltar ao login',
        "Don't have an account?": 'N\u00e3o tem uma conta?',
        'Already have an account?': 'J\u00e1 possui uma conta?',
        'From the lovely folks at': 'Das pessoas ador\u00e1veis da',
        'Source & Roadmap': 'C\u00f3digo fonte & roadmap',
        'Table of contents': '\u00cdndice',
        'All resources': 'Todos os recursos',
        ':locale resources': 'Recursos em :locale',
        'English and :locale resources': 'Recursos em ingl\u00eas e :locale',
    },
    'sv.__JSON__': {
        'Onramp to Laravel': 'P\u00e5farten till Laravel',
        'Providing an easy entrance to Laravel for new developers':
            'Erbjuder en enkel ing\u00e5ng till Laravel f\u00f6r nya utvecklare',
        Home: 'Hem',
        Learn: 'Tr\u00e4na',
        'Learn Laravel': 'L\u00e4r dig Laravel',
        'The tech concepts you should know in order to get a job as a Laravel developer.':
            'De tekniska koncepten du b\u00f6r l\u00e4ra dig f\u00f6r att kunna f\u00e5 ett jobb som en Laravel-utvecklare',
        "That's all, for now.": 'Det var allt, tills vidare',
        'Soon: more and better organized links to places to learn each of these technologies\/tools, a more robust list of technologies, etc., and then later maybe exercises to test them and prove out your learning.':
            'Snart: Fler och b\u00e4ttre organisade l\u00e4nkar till st\u00e4llen att l\u00e4ra sig var och en av dessa teknikerna och verktygen, en mer robust lista av teknologier, etc. Senare kanske \u00e4ven \u00f6vningar f\u00f6r att testa och bekr\u00e4fta vad du l\u00e4rt dig',
        'Log in': 'Logga in',
        Register: 'Registrera dig',
        Glossary: 'Ordlista',
        'All resources': 'Alla resurser',
        ':locale resources': ':locale resurser',
        'English and :locale resources': 'Engelska och :locale resurser',
    },
};
