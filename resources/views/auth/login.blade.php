                    ...
                    <div>
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="email"
                                ...
                                required
                                autofocus
                                class="block w-full px-3 py-2 placeholder-gray-400 transition duration-150 ease-in-out border border-silver rounded-md appearance-none focus:outline-none focus:shadow-outline-blue focus:border-purple sm:text-sm sm:leading-5{{ $errors->has('email') ? ' border-red-500' : '' }}" />
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="password"
                                ...
                                type="password"
                                required
                                class="block w-full px-3 py-2 placeholder-gray-400 transition duration-150 ease-in-out border border-silver rounded-md appearance-none focus:outline-none focus:shadow-outline-blue focus:border-purple sm:text-sm sm:leading-5{{ $errors->has('password') ? ' border-red-500' : '' }}" />
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center">
                            <input id="remember"
                                ...
                                class="w-4 h-4 transition duration-150 ease-in-out text-mint form-checkbox" />
                        ...
                        <div class="text-sm leading-5">
                            <a href="{{ route_wlocale('password.request') }}"
                                class="font-medium transition duration-150 ease-in-out text-purple hover:text-violet focus:outline-none focus:underline">
