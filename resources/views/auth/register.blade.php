                    ...
                    <div>
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="name"
                                ...
                                required
                                autofocus
                                class="block w-full px-3 py-2 placeholder-gray transition duration-200 ease-in-out border border-silver rounded-md appearance-none focus:outline-none focus:shadow-outline-blue focus:border-lake sm:text-sm sm:leading-5{{ $errors->has('name') ? ' border-cabernet' : '' }}" />
                        </div>

                        @error('name')
                            <p class="mt-2 text-xs italic text-cabernet">{{ $errors->first('name') }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="password"
                                ...
                                type="password"
                                required
                                class="block w-full px-3 py-2 placeholder-gray transition duration-200 ease-in-out border border-silver rounded-md appearance-none focus:outline-none focus:shadow-outline-blue focus:border-lake sm:text-sm sm:leading-5{{ $errors->has('password') ? ' border-cabernet' : '' }}" />
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="password-confirm"
                                ...
                                type="password"
                                required
                                class="block w-full px-3 py-2 placeholder-gray transition duration-200 ease-in-out border rounded-md appearance-none border-silver focus:outline-none focus:shadow-outline-blue focus:border-lake sm:text-sm sm:leading-5" />
                        </div>
                    </div>
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm leading-5">
                            <span class="px-2 text-steel bg-white">{{ __('Already have an account?') }}</span>
                        </div>
                    </div>
