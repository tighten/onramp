        ...
        <tabs class="mt-12 lg:mt-32" :hide-tabs-on-desktop="true">
            <tab name="Beginner" :selected="true">
                <div class="px-2 fluid-container md:px-8 lg:px-20 xxl:px-32">
                    ...
                    <div class="flex flex-wrap w-full md:px-1 lg:px-0 lg:-mx-3">
                        @forelse ($standardBeginnerModules as $module)
                            <div class="flex-initial w-full px-3 pb-5 sm:max-w-xs sm:w-1/2 lg:w-1/3 xl:w-1/4">
                                <a class="flex flex-col h-full shadow-md duration-300 transform transition-transform hover:no-underline hover:scale-95 {{ $loop->even ? 'bg-teal-600' : 'bg-teal-400' }}"
                                    href="{{ route_wlocale('modules.show', ['module' => $module, 'resourceType' => 'free-resources']) }}">
                                    <span class="relative block pb-8/12 xl:pb-3/5">
                                        <img class="absolute bottom-0 w-3/4 left-1/2 transform -translate-x-1/2 will-change-transform"
                        ...
                        @empty
                            <p class="px-3 italic text-gray-700">There are currently no modules here. Check back soon.</p>
                        @endforelse
                    </div>
            ...
            <tab name="Intermediate">
                <div class="px-2 fluid-container md:px-8 lg:px-20 lg:mt-32 xxl:px-32">
                    ...
                    <div class="flex flex-wrap w-full md:px-1 lg:px-0 lg:-mx-3">
                        @forelse ($standardIntermediateModules as $module)
                            <div class="flex-initial w-full px-3 pb-5 sm:max-w-xs sm:w-1/2 lg:w-1/3 xl:w-1/4">
                                <a class="flex flex-col h-full shadow-md duration-300 transform transition-transform hover:no-underline hover:scale-95 {{ $loop->even ? 'bg-cornflower-blue' : 'bg-blue-violet' }}"
                                    ...
                                    <span class="relative block pb-8/12 xl:pb-3/5">
                                        {{-- <img
                                            class="absolute bottom-0 w-3/4 left-1/2 transform -translate-x-1/2 will-change-transform"
                                            src="/images/temp/img_basicwebsite.svg" alt="Image for the {{ $module->name }} module."> --}}
                                    </span>
                                    <span class="flex-1 block p-5 pb-8 bg-white xl:px-8 xl:pb-10">
                                        <h4 class="font-semibold tracking-tighter text-east-bay">{{ $module->name }}</h4>
            ...
            <tab name="Advanced">
                <div class="px-2 fluid-container md:px-8 lg:px-20 lg:mt-32 xxl:px-32">
                    ...
                    <div class="flex flex-wrap w-full md:px-1 lg:px-0 lg:-mx-3">
                        @forelse ($standardAdvancedModules as $module)
                            <div class="flex-initial w-full px-3 pb-5 sm:max-w-xs sm:w-1/2 lg:w-1/3 xl:w-1/4">
