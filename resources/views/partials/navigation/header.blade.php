        ...
        <div class="items-center justify-between flex-1 hidden pl-12 lg:flex">
            <div class="flex-1">
                <nav class="flex items-center">
                    <a class="block mx-1 text-xl font-semibold transition-colors duration-300 ease-in-out text-violet hover:text-white hover:bg-indigo-700 hover:no-underline px-3 py-1 rounded @if (Route::currentRouteName() === 'modules.index') bg-indigo-100 @endif"
                        href="{{ route_wlocale('modules.index') }}">
                        <span>{{ __('Learn') }}</span>
                    </a>

                    <a class="block mx-1 text-xl font-semibold transition-colors duration-300 ease-in-out text-violet hover:text-white hover:bg-indigo-700 hover:no-underline px-3 py-1 rounded @if (Route::currentRouteName() === 'glossary') bg-indigo-100 @endif"
                        href="{{ route_wlocale('glossary') }}">
                        <span>{{ __('Glossary') }}</span>
                    </a>
                    <a class="block mx-1 text-xl font-semibold transition-colors duration-300 ease-in-out text-violet hover:text-white hover:bg-indigo-700 hover:no-underline px-3 py-1 rounded @if (Route::currentRouteName() === 'tracks') bg-indigo-100 @endif"
