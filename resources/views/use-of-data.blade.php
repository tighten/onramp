...
<div class="w-full bg-white">
    ...
    <div class="py-8 fluid-container">
        <div class="w-full mb-6 max-w-screen-md">
            ...
            <h2 class="mt-8 mb-2 text-xl text-black md:text-2xl">Registration</h2>
            ...
            <h2 class="mt-8 mb-2 text-xl text-black md:text-2xl">Cookies</h2>
            ...
            <p class="mb-1 font-bold leading-normal text-gray-700">Onramp uses various types of cookies, including:</p>

            <ul class="mb-6 ml-5 leading-normal text-gray-700">
            ...
            <p class="mb-1 font-bold leading-normal text-gray-700">We use cookies to recognize you and/or your device(s) for the following:</p>

            <ul class="ml-5 leading-normal text-gray-700">
            ...
            <h2 class="mt-8 mb-2 text-xl text-black md:text-2xl">Securing Data</h2>
            ...
            <h2 class="mt-8 mb-2 text-xl text-black md:text-2xl">Links</h2>
            ...
            <h2 class="mt-8 mb-2 text-xl text-black md:text-2xl">Updates</h2>
