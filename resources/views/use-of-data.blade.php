...
<div class="w-full bg-white">
    <x-hero>
        <h1 class="mb-2 font-bold tracking-wide h2 md:h1">{{ __('Use of Data') }}</h1>
    </x-hero>
    ...
    <div class="pt-12 pb-48 lg:pt-20 fcontainer">
        <div class="w-full max-w-screen-md mx-auto mb-6 text-base lg:text-lg">
            ...
            <p class="mb-4 leading-normal text-steel">
            ...
            <p class="mb-4 leading-normal text-steel">Registering for an account is not a requirement for using the site unless you would like to track your progress as you complete modules, resources, and skills.</p>

            <h2 class="mt-8 mb-5 text-xl font-semibold lg:mt-12 md:text-2xl">Cookies</h2>

            <p class="mb-4 leading-normal text-steel">Cookies are small data files that we store on your computer or device and access each time you visit the site.</p>

            <p class="mb-1 font-semibold leading-normal text-steel">Onramp uses various types of cookies, including:</p>

            <ul class="mb-6 leading-normal text-steel">
            ...
            <p class="mb-1 font-semibold leading-normal text-steel">We use cookies to recognize you and/or your device(s) for the following:</p>

            <ul class="leading-normal text-steel">
            ...
            <p class="mb-4 leading-normal text-steel">Onramp may link to external sites that are not operated by us. Please be aware that we have no control over the content and practices of these sites, and cannot accept responsibility or liability for their respective privacy policies.</p>

            <h2 class="mt-8 mb-5 text-xl font-semibold lg:mt-12 md:text-2xl">Updates</h2>

            <p class="mb-4 leading-normal text-steel">We reserve the right to change the information outlined here at any given time. We encourage you to frequently visit this page to ensure you are up to date with the latest changes.</p>
        </div>
    </div>
</div>
@endsection
