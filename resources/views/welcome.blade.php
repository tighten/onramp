...
@section('content')
    <div class="w-full bg-white">
        ...
        <div class="overflow-hidden"
            ...
            <div class="relative pt-12 pb-16 fluid-container lg:pt-40 lg:pb-32">
                <picture>
                    ...
                    <img class="absolute left-0 z-0 -ml-48 transform -translate-y-1/2 opacity-50 pointer-events-none h-760-px top-1/2 -scale-x-100 lg:scale-x-100 lg:h-1630-px lg:-ml-4/12"
                ...
                <div class="relative flex flex-wrap pt-6 lg:justify-center lg:text-center lg:pt-16">
                    <div class="flex items-center w-full my-5 lg:w-2/6 lg:flex-wrap lg:justify-center">
                        <div
                            class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-teal bg-teal-dark md:w-20 md:h-20">
        ...
        <div class="pt-10 pb-20 overflow-hidden text-white bg-violet lg:pt-24 lg:pb-40">
            <div class="relative fluid-container">
                <picture>
                    <source media="(min-width: 1024px)"
